const newsContent = [
  ...
  },
  {
    ...
    content:
      '<p>With the task to implement the Nigeria government’s National Social Housing Programme (NSHP), Family Homes Funds has struck partnership with Africa’s largest cement producers, Dangote Cement to deliver 300,000 affordable houses in the Federal Capital Territory and 36 states of the country.</p>' +
      '<p>Following a series of management meetings between both parties, Dangote Cement has now committed to supplying cement across Family Homes Funds sites at heavily discounted prices</p>' +
      '<p>Given that the objective of the NSHP is to deliver exceptionally affordable homes for Nigerians on low income, this development guarantees a further reduction in the cost of construction of the 300,000 houses.</p>' +
      '<p>The National Social Housing Programme (NSHP) which is Nigeria government’s response to the health and economic challenges of Coronavirus is going to provide 300,000 homes and 1,800,000 jobs across the 36 states and the Federal Capital Territory of Nigeria.</p>' +
  ...
  },
  {
    ...
    content:
      ...
      '<p>The agreement with off-grid power solution ensures that Family Homes Funds houses under the NSHP have access to off-grid solar power.</p>' +
      '<p>This, according to the MD of Family Homes Funds, Femi Adewole is a ‘’joint off-thinking’’ partnership with the Power Sector Economic Sustainability Committee that will give people on low-income access to shelter and power at an affordable price.</p>' +
  ...
  },
  {
    ...
    date: '2nd Mar, 2021.',
    desc:
      'As the National Social Housing Programme (NSHP) that plans to build 300,000 houses affordable houses for low-income earners across the country continues to gain momentum, more states are signing up for the programme. The latest is Enugu state which has provided up to 60 hectares of land in Agbamere Eha-Alumona for the programme.',
    content:
