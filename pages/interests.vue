  ...
  data() {
    return {
      partnersType: [
        {
          bg: 'individual.jpg',
          url: 'https://assessment.nshp.gov.ng/individual',
          image: 'partner-w',
          title: 'Individuals',
          titleMobile: 'Individuals',
        },
        {
          bg: 'cooperative.jpg',
          url: 'https://assessment.nshp.gov.ng/co-operatives',
          image: 'partner-w',
          title: 'Cooperatives/Organised Groups',
          titleMobile: 'Cooperatives / <br>Organised Groups)',
        },
        {
