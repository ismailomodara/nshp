      ...
      partnersType: [
        {
          ...
          url: 'http://staging-form.masshousing.ng/delivery-partners',
          image: 'partner-w',
        ...
        },
        {
          ...
          url: 'http://staging-form.masshousing.ng/delivery-partners-group',
          image: 'partner-w',
        ...
        {
          bg: 'consultant.jpg',
          url: 'http://staging-form.masshousing.ng/management-consultants',
          image: 'consultant-w',
          title: 'Independent Project Managers',
          titleMobile: 'Independent<br> Project Managers',
        },
        {
          bg: 'contractor.jpg',
          url: 'http://staging-form.masshousing.ng/management-contractors',
          image: 'contractor-w',
          title: 'Management Contractors',
          titleMobile: 'Management Contractors',
        },
        {
          bg: 'manufacturer.jpg',
          url: 'http://staging-form.masshousing.ng/manufacturers',
          image: 'supplier-w',
          title: 'Manufacturers',
        ...
        {
          bg: 'supplier.jpg',
          url: 'http://staging-form.masshousing.ng/supplier',
          image: 'supplier-w',
          title: 'Suppliers',
