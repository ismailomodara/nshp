  ...
  <div>
    ...
    <div class="ms-section">
      <div class="ms-section--heading">
        <p>
          This Privacy policy between The National Social Housing Programme of
          3rd Floor, Sinoki House, off Central Business District, Abuja
          (hereinafter referred to as NSHP) and you, constitutes our commitment
          to your privacy on our administrative records, websites, social media
      ...
      <el-container>
        <el-row type="flex" :gutter="40" class="flex-wrap">
          <el-col :lg="24">
            <div class="ms-policy--section">
              <h5>1.0 Your Privacy Rights</h5>
              <p>
                This Privacy Policy describes your privacy rights regarding our
                collection, use, storage, sharing and protection of your
                personal information. It applies to the NSHP website and all
                database applications, services, tools and physical contact with
              ...
              <p>
                ...
                you know your security details, you must promptly notify us at
                hello@nshp.gov.ng
              </p>
            </div>
            <div class="ms-policy--section">
              ...
              <p>
                ...
                non-official purposes (collectively “NSHP services”). This
                Policy governs the use of NSHP services and intervention
                projects by our users and stakeholders unless otherwise agreed
                through written contract. We may amend this Privacy Policy at
                any time by posting a revised version on our website or placing
                such notice at conspicuous points at our office facilities. The
                revised version will be effective 7-days after publication.
              </p>
            </div>
            <div class="ms-policy--section">
              <h5>3.0 Your Personal Information</h5>
              <p>
                When you use NSHP Services, we collect information sent to us by
                your computer, mobile phone or other electronic access device.
                The automatically collected information includes but not limited
                to- data about the pages you access, computer IP address, device
                ID or unique identifier, device type, geo-location information,
                computer and connection information, mobile network information,
                statistics on page views, traffic to and from the sites,
                referral URL, ad data, standard web log data, still and moving
                images.
              </p>
              <p>
                We may also collect information you provide us including but not
                limited to- information on web form, survey responses account
                update information, email, phone number, organization you
                represent, official position, correspondence with NSHP support
                services and telecommunication with NSHP. We may also collect
                information about your transactions, enquiries and your
              ...
              <p>
                ...
                sites are not controlled by NSHP and we are therefore not liable
                for how they use it.
              </p>
            </div>
            <div class="ms-policy--section">
              <h5>4.0 What we do with your personal information</h5>
              <p>
              ...
              <ul>
                <li>Provide NSHP services and support;</li>
                <li>
                ...
                <li>
                  Improve NSHP Services by implementing aggregate customer or
                  user preferences;
                </li>
                <li>
                  Measure the performance of the NSHP Services and improve
            ...
            <div class="ms-policy--section">
              <h5>6.0 How we protect your personal information</h5>
              <p>
            ...
            <div class="ms-policy--section">
              <h5>
                7.0 How We Share your information within NSHP and other users
              </h5>
              <p>
                During your interaction with our website or premises, we may
                provide other Ministries, Departments, Agencies (MDA), other
                ...
                of performing our statutory mandate to you or third parties.
              </p>
              <p>
                We work with third parties, especially government agencies to
                perform NSHP services and implement its mandate. In doing so, a
                third party may share information about you with us, such as
                your email address or mobile phone number.
              </p>
              <p>
                You accept that your pictures and testimonials on all social
                media platforms about NSHP can be used for limited promotional
                purposes by us. This does not include your trademark or
              ...
              <p>
                ...
                essential information to aid the implementation of our mandate.
            ...
            <div class="ms-policy--section">
              ...
              <p>
                ...
                strong controls and security safeguards at the technical and
                operational levels. This site uses Secure Sockets
                Layer/Transport Layer Security (SSL/TLS) to ensure secure
                ...
                points such as your PC and the connecting server. Any data
              ...
              <p>
                NSHP has also taken measures to comply with global Information
                Security Management Systems (ISMS) we therefore have put in
                place digital and physical security measures to limit or
                eliminate possibilities of data privacy breach incidents.
              </p>
            </div>
            <div class="ms-policy--section">
              <h5>9.0 Data Confidentiality Rights</h5>
              <p>
                ...
                of any and all information we keep on you, if such requests are
                made in compliance with the Freedom of Information Act and other
                relevant enactments. While NSHP is responsible for safeguarding
            ...
            <div class="ms-policy--section">
              <h5>10.0 Links to Other Websites and Premises</h5>
              <p>
                Certain transaction processing channels may require links to
                other websites or Organisations other than ours. Please note
                that NSHP is not responsible and has no control over websites
                outside its domain. We do not monitor or review the content of
                other party’s websites which are linked from our website or
                media platforms. Opinions expressed or materials appearing on
                such websites are not necessarily shared or endorsed by us, and
                NSHP should not be regarded as the publisher of such opinions or
                materials. Please be aware that we are not responsible for the
                privacy practices, or content of these sites. We encourage our
                users to be aware of when they leave our site and to read the
                privacy statements of these sites. You should evaluate the
                security and trustworthiness of any other site connected to this
                site or accessed through this site yourself, before disclosing
                any personal information to them. NSHP will not accept any
            ...
            <div class="ms-policy--section">
              ...
              <p>
                ...
                law, regulation or convention, such provision shall be subject
                to the overriding law, regulation or convention.
              </p>
            </div>
          </el-col>
        </el-row>
